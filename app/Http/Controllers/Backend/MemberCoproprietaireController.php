...
public function StoreMemberCoproprietaire(Request $request)
{
    ...
    // Afficher les données validées pour le débogage
    // dd('Validated Data:', $validatedData);

    // Créer le nouveau membre copropriétaire
    $coproprietaire = MemberCoproprietaire::create($validatedData);

    // Afficher les données insérées pour le débogage
    // dd('Inserted Data:', $coproprietaire);
