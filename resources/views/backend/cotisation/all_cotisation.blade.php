...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <a href="{{route('add.charge')}}" class="btn btn-inverse-primary">Ajouter une Cotisation</a>
        </ol>
    </nav>
            ...
            <th>ID</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $cotisation->appartement->name }}</td>
                                <td>{{ $cotisation->member_coproprietaire->name }}</td>
                                <td>{{ $cotisation->member_syndic->name }}</td>
                                <td>
