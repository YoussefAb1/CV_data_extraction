                    ...
                    <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                        ...
                        <ul class="list-unstyled p-1">
                            <li class="dropdown-item py-2">
                              <a href="{{route('syndic.profile')}}" class="text-body ms-0">
                                <i class="me-2 icon-md" data-feather="user"></i>
                                <span>Profil</span>
                              </a>
                            </li>
                            <li class="dropdown-item py-2">
                              <a href="{{route('syndic.change.password')}}" class="text-body ms-0">
                            ...
                            <li class="dropdown-item py-2">
                              <a href="{{route('syndic.logout')}}" class="text-body ms-0">
