        ...
        <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
                <div class="card rounded">
                    <div class="card-body">
                        <h6 class="card-title">Editer une Facture</h6>
                        <form method="POST" action="{{route('update.facture')}}" class="forms-sample">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select name="etat" class="form-control @error('etat') is-invalid @enderror">
                                    ...
                                    @foreach (['Payee', 'Partiellement payee', 'En attente de paiement', 'Annulee'] as $etat)
