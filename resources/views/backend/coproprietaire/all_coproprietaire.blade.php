...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('add.memberCoproprietaire') }}" class="btn btn-inverse-primary">Ajouter un Copropriétaire</a></li>
        </ol>
    </nav>
                    ...
                    <tbody>
                        @foreach ($coproprietaires as $coproprietaire)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('edit.memberCoproprietaire', $coproprietaire->id) }}" class="btn btn-inverse-warning">Editer</a>
